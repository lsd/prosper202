...
//show tracking code
	...
	$javascript_code = '<script src="http://' . $_SERVER['SERVER_NAME'] . '/tracking202/static/landing.php?lpip=' . $landing_page_row['landing_page_id_public'] .'" type="text/javascript"></script>';
  ...
  $tracking202outbound = \'http://'.$_SERVER['SERVER_NAME'].'/tracking202/redirect/off.php?acip='.$aff_campaign_row['aff_campaign_id_public'].'&pci=\'.$_COOKIE[\'tracking202pci\'];     
