...
<table cellpadding="0" cellspacing="1" class="m-stats">
	<tr>   
		<th><a class="onclick_color" onclick="loadContent('sort_referers.php','','<? echo $html['sort_referer_referer_order']; ?>');">Referer</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_referers.php','','<? echo $html['sort_referer_clicks_order']; ?>');">Clicks</a></th> 
		<th><a class="onclick_color" onclick="loadContent('sort_referers.php','','<? echo $html['sort_referer_leads_order']; ?>');">Leads</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_referers.php','','<? echo $html['sort_referer_su_ratio_order']; ?>');">S/U</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_referers.php','','<? echo $html['sort_referer_payout_order']; ?>');">Payout</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_referers.php','','<? echo $html['sort_referer_epc_order']; ?>');">EPC</a></th> 
		<th><a class="onclick_color" onclick="loadContent('sort_referers.php','','<? echo $html['sort_referer_avg_cpc_order']; ?>');">Avg CPC</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_referers.php','','<? echo $html['sort_referer_income_order']; ?>');">Income</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_referers.php','','<? echo $html['sort_referer_cost_order']; ?>');">Cost</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_referers.php','','<? echo $html['sort_referer_net_order']; ?>');">Net</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_referers.php','','<? echo $html['sort_referer_roi_order']; ?>');">ROI</a></th>
	</tr>   
