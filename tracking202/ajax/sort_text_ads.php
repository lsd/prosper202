...
<table cellpadding="0" cellspacing="1" class="m-stats">
	<tr>   
		<th><a class="onclick_color" onclick="loadContent('sort_text_ads.php','','<? echo $html['sort_text_ad_text_ad_order']; ?>');">Text Ad</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_text_ads.php','','<? echo $html['sort_text_ad_clicks_order']; ?>');">Clicks</a></th> 
		<th><a class="onclick_color" onclick="loadContent('sort_text_ads.php','','<? echo $html['sort_text_ad_leads_order']; ?>');">Leads</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_text_ads.php','','<? echo $html['sort_text_ad_su_ratio_order']; ?>');">S/U</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_text_ads.php','','<? echo $html['sort_text_ad_payout_order']; ?>');">Payout</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_text_ads.php','','<? echo $html['sort_text_ad_epc_order']; ?>');">EPC</a></th> 
		<th><a class="onclick_color" onclick="loadContent('sort_text_ads.php','','<? echo $html['sort_text_ad_avg_cpc_order']; ?>');">Avg CPC</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_text_ads.php','','<? echo $html['sort_text_ad_income_order']; ?>');">Income</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_text_ads.php','','<? echo $html['sort_text_ad_cost_order']; ?>');">Cost</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_text_ads.php','','<? echo $html['sort_text_ad_net_order']; ?>');">Net</a></th>
		<th><a class="onclick_color" onclick="loadContent('sort_text_ads.php','','<? echo $html['sort_text_ad_roi_order']; ?>');">ROI</a></th>
	</tr>   
...
<? if ($query['pages'] > 2) { ?>
	<div class="offset">   <?
		if ($query['offset'] > 0) {
			printf(' <a class="onclick_color" onclick="loadContent(\'sort_text_ads.php\',\'%s\',\'%s\');">First</a> ', $i, $html['order']);
			printf(' <a class="onclick_color" onclick="loadContent(\'sort_text_ads.php\',\'%s\',\'%s\');">Prev</a> ', $query['offset'] - 1, $html['order']);
		}
		...
		if ($query['pages'] > 1) {
			for ($i=0; $i < $query['pages']-1; $i++) {                         
				if (($i >= $query['offset'] - 10) and ($i < $query['offset'] + 11)) { 
					...
					printf(' <a %s onclick="loadContent(\'sort_text_ads.php\',\'%s\',\'%s\');">%s</a> ', $class, $i, $html['order'], $i+1);
					unset($class);
				}
			}
		} 
		...
		if ($query['offset'] < $query['pages'] - 2) {
			printf(' <a class="onclick_color" onclick="loadContent(\'sort_text_ads.php\',\'%s\',\'%s\');"">Next</a> ', $query['offset'] + 1, $html['order']);
			printf(' <a class="onclick_color" onclick="loadContent(\'sort_text_ads.php\',\'%s\',\'%s\');">Last</a> ', $query['pages'] - 2, $html['order']); 
		} ?>
	</div>   
<? } ?>
