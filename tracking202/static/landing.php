<? include_once($_SERVER['DOCUMENT_ROOT'] . '/202-config/connect.php'); 
	...
	//this javascript is packed by: http://dean.edwards.name/packer/

	$html['landing_page_id_public'] = htmlentities($_GET['lpip'], ENT_QUOTES, 'UTF-8'); ?>
	...
	function t202Init(){
		...
		var lpip = '<? echo $html['landing_page_id_public']; ?>';
